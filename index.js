...
async function download(url) {
    const p = 'wcda/'+url.substring(url.lastIndexOf('/')+1);
    if (fs.existsSync(p)) {
        console.log('ignore');
        return;
    }
